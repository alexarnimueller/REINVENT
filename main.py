...
parser.add_argument('--scoring-function', action='store', dest='scoring_function',
                    choices=['activity_model', 'tanimoto', 'no_sulphur'], default='tanimoto',
...
parser.add_argument('--learning-rate', action='store', dest='learning_rate', type=float, default=0.0005)
...
parser.add_argument('--prior', action='store', dest='restore_prior_from', default='data/Prior.ckpt',
                    help='Path to an RNN checkpoint file to use as a Prior')
parser.add_argument('--agent', action='store', dest='restore_agent_from', default='data/Prior.ckpt',
